...
SocialSharing.prototype.shareScreenshot = function (successCallback, errorCallback) {
  cordova.exec(successCallback, this._getErrorCallback(errorCallback, "shareScreenshot"), "SocialSharing", "shareScreenshot", []);
};
